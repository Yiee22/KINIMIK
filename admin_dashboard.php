...
<div class="sidebar" id="sidebar">
  ...
  <ul class="menu">
    ...
    <li data-title="Registration" onclick="navigate('registration.php', this)">
    ...
    <li data-title="User Management" onclick="navigate('users.php', this)">
      <i class="fa fa-user-cog"></i><span>User Management</span>
    </li>
    <li data-title="Reports" onclick="navigate('reports.php', this)">
